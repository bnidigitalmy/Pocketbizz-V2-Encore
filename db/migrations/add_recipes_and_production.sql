-- ============================================================================
-- RECIPES & PRODUCTION BATCHES MIGRATION
-- Links stock items to finished products with automatic cost calculations
-- ============================================================================

-- ============================================================================
-- UPDATE PRODUCTS TABLE - Add Recipe/Cost Fields
-- ============================================================================
ALTER TABLE products ADD COLUMN IF NOT EXISTS units_per_batch INTEGER NOT NULL DEFAULT 1;
ALTER TABLE products ADD COLUMN IF NOT EXISTS labour_cost NUMERIC(10,2) NOT NULL DEFAULT 0;
...
ALTER TABLE products ADD COLUMN IF NOT EXISTS materials_cost NUMERIC(10,2) NOT NULL DEFAULT 0;
ALTER TABLE products ADD COLUMN IF NOT EXISTS total_cost_per_batch NUMERIC(10,2) NOT NULL DEFAULT 0;
ALTER TABLE products ADD COLUMN IF NOT EXISTS cost_per_unit NUMERIC(10,2) NOT NULL DEFAULT 0;
ALTER TABLE products ADD COLUMN IF NOT EXISTS suggested_margin NUMERIC(5,2) NOT NULL DEFAULT 30.00;
ALTER TABLE products ADD COLUMN IF NOT EXISTS suggested_price NUMERIC(10,2) NOT NULL DEFAULT 0;
