-- ============================================================================
-- FIX RECIPES STRUCTURE - SAFE VERSION WITH ERROR HANDLING
-- ============================================================================
...
-- ============================================================================
-- STEP 2: Backup OLD recipe_items (if it existed)
-- ============================================================================
-- Note: This might fail if recipe_items doesn't exist yet, that's OK!
DO $$
BEGIN
    EXECUTE 'CREATE TABLE recipe_items_backup AS SELECT * FROM recipe_items';
    RAISE NOTICE '✅ Backed up old recipe_items';
EXCEPTION WHEN undefined_table THEN
    RAISE NOTICE '⚠️  No existing recipe_items to backup (fresh install)';
END $$;
...
-- Add recipe_id to production_batches
DO $$
BEGIN
    ...
    RAISE NOTICE '✅ Added recipe_id to production_batches';
EXCEPTION WHEN OTHERS THEN
    RAISE NOTICE '⚠️  Could not add recipe_id to production_batches: %', SQLERRM;
END $$;
...
EXCEPTION WHEN OTHERS THEN
    RAISE NOTICE '⚠️  Could not add supplier_id to stock_items: %', SQLERRM;
END $$;
...
RAISE NOTICE '✅ Created calculate_recipe_cost function';
...
RAISE NOTICE '✅ Created record_production_batch function';

-- ============================================================================
-- STEP 9: CREATE TRIGGER - AUTO UPDATE RECIPE COSTS
-- ============================================================================
...
RAISE NOTICE '✅ Created trigger for auto cost calculation';
...
BEGIN
    ...
    RAISE NOTICE '';
    RAISE NOTICE '✅ Created: recipes table';
    RAISE NOTICE '✅ Created: recipe_items table (new structure)';
    RAISE NOTICE '✅ Created: production_ingredient_usage table';
    RAISE NOTICE '✅ Updated: production_batches (added recipe_id)';
    RAISE NOTICE '✅ Updated: stock_items (added supplier_id)';
    RAISE NOTICE '✅ Created: calculate_recipe_cost() function';
    RAISE NOTICE '✅ Created: record_production_batch() function';
    RAISE NOTICE '✅ Created: auto cost calculation trigger';
    RAISE NOTICE '';
    RAISE NOTICE '⚠️  NOTE: Old recipe_items backed up to recipe_items_backup';
    RAISE NOTICE '';
    RAISE NOTICE '🎯 NEXT STEP: Restart your Flutter app!';
    RAISE NOTICE '';
END $$;
